<script lang="ts">
    ...
    import { instructorRegisterSchema, type InstructorRegisterFormSchema } from "./schema";
    import {
        type SuperValidated,
        type Infer,
        superForm,
    ...
    export let data: SuperValidated<Infer<InstructorRegisterFormSchema>>;

    const form = superForm(data, {
        validators: zodClient(instructorRegisterSchema),
    });
...
<form method="POST" use:enhance>
    ...
    <input type="hidden" name="isInstructor" value="true" />
</form>
